...
tenant_unit_list = readtable('tenant_unit_list.csv', 'VariableNamingRule', 'preserve');

% List of component and damage states ids associated with the damage matrix
comp_ds_list = readtable('comp_ds_list.csv', 'VariableNamingRule', 'preserve');

% List of component and damage states in the performance model
comp_population = readtable('comp_population.csv', 'VariableNamingRule', 'preserve');
...
% some models come prebuilt with component information within
% building_models. remove these in this case
if isfield(building_model.comps, 'story')
    building_model.comps = rmfield(building_model.comps, 'story');
end
